...
while key != 27:               # While Esc key is not pressed
    ...
    # Increasesthe speed of Snake as its length increases
...
# If SPACE BAR is pressed, wait for another
    ...
    snake.insert(0, [snake[0][0] + (key == KEY_DOWN and 1) + (key == KEY_UP 
                        and -1), snake[0][1] + (key == KEY_LEFT and -1) + (key == KEY_RIGHT and 1)])
